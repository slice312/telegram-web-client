...
import {Button, TextField, Box, Autocomplete, Typography} from "@mui/material";
...
import TelegramLogo from "@/assets/icons/icons8-telegram-250.svg";
...
export const Phone = () => {
    ...
    const [selectedCountry, setSelectedCountry] = useState(countries[50])

    useEffect(() => {
        setText(`+${selectedCountry.phone}`)
    }, [selectedCountry]);
    ...
    return (
        <>
            <Form>
                <img src={TelegramLogo} alt='icon' width="200" height="200"/>
                <Heading variant="h4" component="h4">
                    Sign in to Telezhka.
                </Heading>
                <Subheading variant="h6" component="h6">
                    Please choose a country and enter your phone number.
                </Subheading>
                <Autocomplete
